    ...
    return (
        <>
            ...
            <Grid container>
                ...
                <Grid item xs={12} md={6} sx={{ backgroundColor: '#F5F6F9', minheight: '100%' }}>
                    <div style={{ position: 'relative', height: '100vhvh', overflowY: 'auto', width: '100%', marginTop: '10%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                        
                        <Grid container rowSpacing={3} columns={20} sx={{ width: '80%', backgroundColor: 'white', padding: '2%', minheight: '89.5vh' }}>
